// import 'package:e_sewa/constants/boxes_decorations.dart';
// import 'package:e_sewa/generated/l10n.dart';
// import 'package:e_sewa/theme.dart';
import 'package:flutter/material.dart';
import 'package:flutter_template/e-rent/controllers/test_api_controller.dart';
          ...
          child: Padding(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton(
                ...
                value: testApiController.assetCategoryList,
                style: const TextStyle(fontWeight: FontWeight.bold),
                items: items.map(buildMenuItem).toList(),
                onChanged: (Object? value) {},
                // items: testApiController.assetCategoryList.
                //     .map(
                //       (map) => DropdownMenuItem(
                //           child: Text(map.value), value: map.id),
                //     )
                //     .toList(),
                // onChanged: (newValue) => testApiController.,
              ),
              // ),
              // child: Obx(
              //   () => DropdownButton(
              //     dropdownColor: Colors.black,
              //     hint: Text(
              //       testApiController.assetCategoryList.toString(),
